...
class ClientInline:
    ...
    def get_dota_keyboard(self, buttons_to_change):
        ...
        hours_button = InlineKeyboardButton(text="Выбрать количество часов в доте", callback_data="hours")
