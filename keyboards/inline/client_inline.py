...
class SteamClientInline:
    ...
    def get_prices_keyboard(self):
        price1 = InlineKeyboardButton(text="<1000", callback_data="<1000")
        price2 = InlineKeyboardButton(text="1000 - 2000", callback_data="1000-2000")
        price3 = InlineKeyboardButton(text="2001 - 3000", callback_data="2001-3000")
        price4 = InlineKeyboardButton(text="3001 - 4500", callback_data="3001-4500")
        price5 = InlineKeyboardButton(text="4501 - 6000", callback_data="4501-6000")
        price6 = InlineKeyboardButton(text="6001 - 8000", callback_data="6001-8000")
        price7 = InlineKeyboardButton(text="8000 - 9999", callback_data="8000-9999")
        price8 = InlineKeyboardButton(text=">10000", callback_data=">10000")
